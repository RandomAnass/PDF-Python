# -*- coding: utf-8 -*-
"""
Created on Sat Aug 21 06:20:19 2021
@author: anass
"""
...
def ocr_file(*args):
    ...
    search_str = args[2]
    pages = args[3]
    highlight_readable_text = args[4]
    action = args[5]
    show_comparison = args[6]
    generate_output = args[7]
    # Opens the input PDF file
...
#ocr_file(input_path, output_path, search_str, pages, highlight_readable_text, action, show_comparison, generate_output)


# Run in recursive mode
#ocr_folder(input_folder, recursive, search_str, pages, action, generate_output)
